...
public class MessagingService extends FirebaseMessagingService {
    ...
    private static final String TYPE_FIELD_DATA    = "DATA";
    private static final String TYPE_FIELD_SERVICE = "SERVICE";
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        if (remoteMessage.getData().size() > 0) {
            ...
            if (remoteMessage.getData().get(TYPE_FIELD).equals(TYPE_FIELD_DATA)) {
                ...
                Message message = new Message(phone, remoteMessage.getSentTime(), remoteMessage.getData().get(TEXT_FIELD));
